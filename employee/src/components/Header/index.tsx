          ...
          <form action="https://formbold.com/s/unique_form_id" method="POST">
            <div className="relative">
              <button className="absolute left-0 top-1/2 -translate-y-1/2">
                <svg
                  className="fill-body hover:fill-primary dark:fill-bodydark dark:hover:fill-primary text-white"
                  width="20"
                  height="20"
                  viewBox="0 0 20 20"
                  fill="none"
              ...
              <input
                ...
                className="w-full bg-transparent pl-9 pr-4 font-medium focus:outline-none xl:w-125 text-white"
              />
            </div>
          </form>
        </div>
