...
const CLOUDINARY_UPLOAD_PRESET = "xoftics";
    ...
    <div className="mt-2 w-full">
      <div className="flex flex-wrap gap-4">
        ...
        {addedPhotos.length < maxPhotos && (
          <label
            className={`text-gray-600 flex h-10 w-24 cursor-pointer items-center justify-center border bg-transparent p-2 text-lg ${
